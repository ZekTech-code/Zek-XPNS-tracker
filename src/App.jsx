        ...
        {currentUser && !loading && (
          <div className={`app${sidebarCollapsed ? ' collapsed' : ''}`} id="appView">
            ...
            <main className="main-content">
              ...
              {activeView === 'history' && <HistoryView transactions={transactions} currency={currency} filter={historyFilter} setFilter={setHistoryFilter} search={search} setSearch={setSearch} onDelete={deleteTransaction} onExportPDF={exportPDF} hideBalance={hideBalance} />}
